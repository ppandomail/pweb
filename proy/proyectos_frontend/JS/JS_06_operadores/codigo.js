...
console.log("Operadores de comparación o relacionales");
...
console.log("Identidad: op1 === op2 ", op1 === op2); // Estricta (tipo y valor)
...
obj = { a: 3, b: 4 };
console.log("Otroa Operadores");
console.log("Condicional ternario ", 5 >= 18 ? "si" : "no");
console.log("Tipo de dato ", typeof 5.9);
console.log("Punto ", obj.a);
console.log("Corchete ", obj["a"]);
console.log("Creación ", new String("pepe"));
console.log("Delete ", delete obj.a);
console.log("Existencia ", "a" in obj);
console.log("Instanceof ", "pepe" instanceof String);
